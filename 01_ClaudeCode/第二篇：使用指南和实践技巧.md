...
![image-20260506104504699](img/image-20260506104504699.png)

###### 2.2 使用

安装完成后，plugin 里的各组件（MCP Servers、Skills、Subagents、Hooks）就已经被分发到相应目录了，直接按各组件的使用方式使用即可，跟手动安装的效果完全一致
