...
有的安装教程会给我们提供下图这样的配置，我们只需要把这个配置复制粘贴到相应【存储位置】的【mcpServers 字段】里即可，一定要想清楚把这个 mcpServer 安装到什么作用域，这里安装到项目级

![image-20260428175301054](img/image-20260428175301054.png)
